...
class McpAuthWwwAuthenticateParams(TypedDict, total=False):
    ...
    resourceMetadataUrl: Required[str]
    scope: str
    error: str
...
class McpAuthRequest(TypedDict, total=False):
    ...
    wwwAuthenticateParams: Required[McpAuthWwwAuthenticateParams]
...
McpAuthHandler = Callable[
    [McpAuthRequest, dict[str, str]],
    McpAuthResult | McpAuthToken | None | Awaitable[McpAuthResult | McpAuthToken | None],
]
            ...
            case McpOauthRequiredData() as data:
                ...
                request: McpAuthRequest = {
                    ...
                    "wwwAuthenticateParams": {
                        "resourceMetadataUrl": data.www_authenticate_params.resource_metadata_url,
                    },
                }
                if data.www_authenticate_params.scope is not None:
                    request["wwwAuthenticateParams"]["scope"] = data.www_authenticate_params.scope
                if data.www_authenticate_params.error is not None:
                    request["wwwAuthenticateParams"]["error"] = data.www_authenticate_params.error
                if data.static_client_config is not None:
                    ...
                    if data.static_client_config.public_client is not None:
                        static_client_config["publicClient"] = data.static_client_config.public_client
